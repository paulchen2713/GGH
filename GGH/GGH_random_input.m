%
% GGH public key cryptography with randomized v, w, and r
%   ref. p.410 Example 7.36
%
clear;
clc;
%
fprintf('GGH public key cryptography Example 7.36 with randomized v, w, and r.\n\n');
%
% theoretically, n is the bigger the better, but here for our laptop's
% computation efficiency, we take n less or equal to 12
%
n = 10;
